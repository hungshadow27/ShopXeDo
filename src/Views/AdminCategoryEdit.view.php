...
<main class="py-6 px-3 min-h-[1000px] ml-64">
    ...
    <form action="<?= ROOT ?>/admin/categories/edit/<?php echo $category->id; ?>" method="POST" class="space-y-6 p-3 border border-gray-500 rounded-md">
        ...
        <div>
            ...
            <input type="text" name="image" value="<?php echo htmlspecialchars($category->image); ?>" class="w-full p-2 border rounded focus:outline-none focus:border-blue-500" placeholder="category_image">
        </div>
        <div>
